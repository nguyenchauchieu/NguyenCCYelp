...
struct Constants {
    ...
    static let DISTANCE_TO_METER_RATIO = 1609.34
    
    static let DISTANCE = [["name": "Auto", "value": "0"],
                           ["name": "0.3 miles", "value": "0.3"],
                           ["name": "1 mile", "value": "1"],
                           ["name": "5 miles", "value": "5"],
                           ["name": "20 miles", "value": "20"]]
    
    static let SORTS = [["name": "Best match", "value": "0"],
                        ["name": "Distance", "value": "1"],
                        ["name": "Highest rated", "value": "2"]]
    
    static let SECTION_HEADER_LABEL = ["Deal", "Distance", "Sort by", "Category"]
